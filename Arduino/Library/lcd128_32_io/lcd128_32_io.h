...
#ifndef _lcd128_32_io_H__
#define _lcd128_32_io_H__
...
#define restart      0xe2
#define seg          0xa0
#define INV_normal   0xa6
#define AP_normal    0xa4
#define BS           0xa3
#define com          0xc8
#define powerCon1    0x2c
#define powerCon2    0x2e
#define powerCon3    0x2f
#define regRatio     0x22
#define EV1          0x81
#define EV2          0x30
#define exit_EC      0xfe
#define enter_EC     0xff
#define DSM_ON       0x72
#define DSM_OFF      0x70
#define DT           0xd6
#define BA           0x90
...
class lcd
{
  ...
  public:
    lcd(int _sda, int _scl);
    void WriteByte_command(int cmd);
    void WriteByte_dat(int dat);
    void WriteByte_dat(const int *dat);
    void Clear();
    void Init();
