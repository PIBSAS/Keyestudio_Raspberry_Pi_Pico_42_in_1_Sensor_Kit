...
{
	public:
		KETM1650(int pin_SCK,int pin_DIO);
		void	init();
		void	clear();
		// void	clearDot();
...
/**
*/	
KETM1650::KETM1650(int pin_SCK,int pin_DIO)
{
...
/** FrameStart_1650 
 */
void KETM1650::FrameStart_1650(void)
{
...
/** FrameEnd_1650 
 */
void KETM1650::FrameEnd_1650(void)
{
	digitalWrite(_pin_DIO , LOW);
	digitalWrite(_pin_SCK , HIGH);		  
	digitalWrite(_pin_DIO , HIGH);
...
/** FrameAck_1650 
 */
boolean KETM1650::FrameAck_1650(void)
{
...
/** writeByte 
 */
boolean KETM1650::writeByte(unsigned char firstByte,unsigned char secondByte)
{
	unsigned char tmp;
	unsigned char i=0;
	boolean err=0;		
 ...
 *  
 */
boolean KETM1650::displayOneDigi(unsigned char digi,unsigned char cha)
{
	unsigned char tmp = 0;
	boolean err = 0;
 ...
 *  
 */
void KETM1650::displayString(char *aString)
{
	for (int i=0; i<iNumDigits; i++) {
 ...
 *  
 */
void KETM1650::displayString(String sString)
{
	for (int i=0; i<iNumDigits; i++) {
 ...
 *    保留两位小数
 */
void KETM1650::displayString(float value)
{
 ...
 */
void KETM1650::displayString(double value)
{
 ...
 *      超出显示范围，则不显示
 */
void KETM1650::displayString(int value)
{
 ...
 */
boolean KETM1650::displayOff(unsigned char lightLevel,unsigned char SegmentMode,unsigned char WorkMode)
{
	unsigned char tmp = 0;
	boolean err = 0;
 ...
 *		WorkMode		工作模式（待机/正常工作模式）
 */
boolean KETM1650::displayOn(unsigned char lightLevel,unsigned char SegmentMode,unsigned char WorkMode)
{
	unsigned char tmp = 0;
	boolean err = 0;
 ...
 */
void KETM1650::setDot(unsigned int aPos, bool aState) {
 ...
 */
void KETM1650::setBrightness(unsigned int aValue) {
 ...
 */
int KETM1650::displayRunning(String aString){
...
int KETM1650::displayRunning(char *aString){
 ...
 * returns: number of iterations remaining to display the whole string
 */
int KETM1650::displayRunningShift() {
